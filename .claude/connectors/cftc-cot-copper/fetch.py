#!/usr/bin/env python3
"""Fetch three years of COMEX Copper #1 positioning from the CFTC public API."""
...
SPEC = ContractSpec(
    contract="COPPER- #1", contract_code="085692",
    instrument_label="COMEX Copper #1", filename_stem="cot_copper", verify_label="Copper #1",
)
