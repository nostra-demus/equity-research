#!/usr/bin/env python3
"""Fetch three years of ICE Sugar No. 11 positioning from the CFTC public API."""
...
SPEC = ContractSpec(contract="SUGAR NO. 11", contract_code="080732", instrument_label="ICE Sugar No. 11", filename_stem="cot_sugar_no11", verify_label="Sugar No. 11")
