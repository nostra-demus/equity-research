#!/usr/bin/env python3
"""Fetch three years of ICE Cocoa positioning from the CFTC public API."""
...
SPEC = ContractSpec(contract="COCOA", contract_code="073732", instrument_label="ICE Cocoa", filename_stem="cot_cocoa", verify_label="Cocoa")
