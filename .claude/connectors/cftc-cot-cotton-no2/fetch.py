#!/usr/bin/env python3
"""Fetch three years of ICE Cotton No. 2 positioning from the CFTC public API."""
...
SPEC = ContractSpec(contract="COTTON NO. 2", contract_code="033661", instrument_label="ICE Cotton No. 2", filename_stem="cot_cotton_no2", verify_label="Cotton No. 2")
