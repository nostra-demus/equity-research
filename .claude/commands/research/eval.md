...
# J FRAMEWORK SOURCE CONTRACTS (suite-level, run once; protects §24 wiring + §17 catalyst + three-tier output + scheduler + audit command layer)
FRAMEWORK_CONTRACTS={
 ...
 ".claude/commands/research/verify-evidence.md":["READ-ONLY on every run artifact","verification_report.json","integrity_score","claim_checks","No fabrication"],
 ".claude/commands/research/pre-mortem.md":["pre_mortem.json","confidence_haircut","recommended_confidence","never raise it","READ-ONLY on every run artifact"],
 ".claude/commands/research/expectations-gap.md":["expectations_gap.json","gap_direction","edge_score","is_exploitable","variant_perception_quality"],
 ".claude/commands/research/review-decisions.md":["decision_review.json","NEVER edit","append-only","forecast_results","module_calibration_notes"],
 ".claude/commands/research/calibrate.md":["calibration_summary.json","selected_minus_rejected_pct","Brier","Pre-data","insufficient"],
}
jchecks=[]
