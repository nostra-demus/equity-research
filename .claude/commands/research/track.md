...
for drp in sorted(glob.glob("analyses/*/decision_record.json")):
    ...
    calls.append({
        ...
        "decision": d.get("decision"), "basket": d.get("basket"), "confidence": d.get("confidence_score"),
...
for c in calls:
    ...
    parts.append(
        ...
        f'- Called **{cell(c["decision_date"])}**  ·  basket {cell(c["basket"])}  ·  confidence {cell(c["confidence"])}/100  ·  horizon {cell(c["time_horizon"])}\n'
