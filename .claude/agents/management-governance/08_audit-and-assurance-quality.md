...
12. **Committee ↔ auditor engagement (A4-12).** Green is private sessions held (the committee meets the auditor WITHOUT management) and the auditor attending committee meetings; red is no evidence of either. Composition is `05`'s item (A2-01) — you judge only the engagement.
...
| A4-13 — NFRA / PCAOB / ICAI orders vs firm or signing partner | | No orders against either | Any active order or debarment (also RF-REG-001) | | |
...
Bands: non-audit <25% of audit = Green; non-audit ≥ audit = Red (RF-AUD-004). Fee within ±50% of the peer median, moving with scale = Green; fee <50% of peer median, or falling while revenue grows >20% = Red. Name any prohibited service (India Sec 144 / SOX §201 list) rendered.
...
One row per owned checklist item (A4-01 … A4-15, A7-02), ID in the Question/Test column, plus a row for every other material claim in the narrative. Apply RF-AUD-001…006 and RF-REG-001 (regulator discipline of the firm) from the Red-Flag ID Registry; keep canonical IDs so cross-module roll-ups converge.

## Audit & Assurance Quality Score
| Component | Score | Max Score | Evidence |
|---|---:|---:|---|
| Opinion cleanliness & restatement history (A4-05, A4-09, A7-02) | | 25 | |
...
| Internal + secretarial audit + IFC (A4-08, A4-09, A4-11) | | 15 | |
...
- [ ] Every Red row carries its Red Flag ID (RF-AUD-001…006, RF-REG-001) and a follow-up question.
