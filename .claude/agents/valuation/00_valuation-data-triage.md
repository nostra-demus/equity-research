...
memory_profile:
  version: 1
  task: valuation.valuation-data-triage
  episodic_scope: exact-listing
  semantic_topics: [valuation, valuation-data-triage]
  procedure_tags: [valuation, valuation-data-triage]
  cross_company: true
...
- `TICKER`, `DATA_PATH` (resolved below; logical citation label `data/{TICKER}/`), `OUTPUT_PATH = analyses/{TICKER}_{DATE}/valuation/00_valuation-data-triage.md`, `DATE`
