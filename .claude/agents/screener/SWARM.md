...
sources:
  signal_gate:
    ...
    allowed:
      ...
      # Top IBKR-tradable markets — Japan, UK, China, South Korea + US/India deepening (each feed verified live)
      - "Business Today"
      - "CGTN Business"
      - "City A.M."
      - "CnEVPost"
      - "Deccan Herald"
      - "ECNS (China News Service, English)"
      - "Financial Services Agency (FSA Japan)"
      - "Free Press Journal"
      - "Global Times"
      - "Japan Exchange Group (JPX)"
      - "Japan Today"
      - "KED Global (Korea Economic Daily, English)"
      - "Kyodo News (Japan Wire)"
      - "Nasdaq Trader"
