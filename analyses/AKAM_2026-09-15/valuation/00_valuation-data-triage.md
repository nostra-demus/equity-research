> **Reused historical input, September 14.** This unchanged analytical body records the original work, including superseded working-share labels and excluded mechanical values. It is retained for lineage, not current valuation authority. The corrected 01/04/05/07/99 reports use 148.333m economic working shares and control the new publication. The old 153.686m labels and $377.81 mechanical peer output are not adopted by this correction; peer/own-history/SOTP still receive zero value weight. Additional peer exports in the new inventory have not yet received a complete matched valuation.
