...
> verify-evidence verdict = Material issues (not Clean/Minor — integrity 65/100, see verification_report.json)
>
...
# AKAM — Investment Dossier (2026-09-14)
...
Run date: 2026-09-14 | Decision line: AKAM · Nasdaq Global Select Market · USD | Modules: business-model, earnings, balance-sheet-survival, catalyst, competitive-intel, management-governance, valuation | Frozen evidence generation: `c4d3e6273c464a9c80ac6b2d5376f06f8686a7fd7d1593a78ba6741c81cf1d6c`
...
**Decision: Avoid — at $106.79, the only valid value-producing method gives a $68.78 base value, while falling GAAP profitability, 5.14x strict net leverage, and unproven acquisition returns do not justify the cash growth embedded in the price.** [analyses/AKAM_2026-09-14/valuation/99_valuation-synthesis.md, §§1–7; analyses/AKAM_2026-09-14/earnings/99_earnings-synthesis.md, §§1–5; analyses/AKAM_2026-09-14/management-governance/99_management-governance-synthesis.md, §§4–6]

This is a rejection of the long, not a short recommendation. The module's DCF sensitivity bull is only 2.69% above the price, so the master adds a distinct 10%-probability good-outcome case: the reverse-DCF's 16.35% cash-growth path and 5.0466% market-implied WACC together produce $139.68, or +30.80%. That joint tail, plus missing borrow and options data, makes an active short unsuitable. [analyses/AKAM_2026-09-14/valuation/04_intrinsic-dcf.md, §§4–7; analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–2A]
...
| Expected return | **−29.71%** to the $75.06 probability-weighted target; diagnostic because the good-outcome case is a low-probability, two-condition DCF inference |
| Downside risk | **57.25%** to the 12-month `bear_cyclical` level |
| Risk/reward | **−0.52x**; the computed expected reward to a long is negative |
| Understanding /100 | **74.0** — evidence quality and how well the situation is understood, not a buy signal |
| Conviction /100 | **50.0** — direction-aware; the one-model distribution and low-probability joint upside tail limit how much to bet |
...
| Biggest upside driver | Security and CIS growth converts to free cash flow while investors continue to require a cost of capital near the 5.05% market-implied rate |
...
| Killer risk | A lower market-required return and better cash conversion occur together; the explicit good-outcome case reaches $139.68 even though the 6.22% WACC base DCF does not support today's price |
...
**Final answer: I would not buy AKAM today.** Free cash flow (FCF, cash from operations minus total cash capital expenditure) was $629.9m on the module's trailing basis. The reverse discounted-cash-flow model (reverse-DCF, solving for what the share price requires) says $106.79 needs 16.35% annual FCF growth to about $1.245bn by FY2030 at a 6.22% weighted-average cost of capital (WACC, the return demanded by lenders and shareholders). The matched FCF record grew 6.34% annually in FY2023–FY2025 and then fell 9.92% on the latest trailing basis. [analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–5]

- **Confidence:** 50/100 conviction; 74/100 understanding.
- **Position stance:** no position. Track the avoided and foregone return, including upside we miss.
- **What would raise confidence:** a second independent valuation; filed Security/CIS economics; and LTM strict FCF at or above about $733m by Q2 2027 on the same basis.
...
- **What is probably priced in:** $106.79 can be reconciled either by 16.35% annual FCF growth to $1.245bn by FY2030 at the model's 6.22% WACC, or by keeping the DCF cash path and lowering WACC to 5.05%. Those are non-exclusive explanations. [analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–5]
...
- **What evidence proves we are actually different:** by Q2 2027, the same-basis LTM FCF should be moving through roughly $733m, the first-year 16.35% growth step from $629.9m, while category economics and reported margins stop worsening. A result below $733m with no margin recovery supports the engine's negative expectations gap; a result at or above it with lower strict leverage disproves it. This is a judgment test, not a measured base rate. [analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–5]
...
- **Final thesis:** reject the long at $106.79. Do not short it because the scenario set contains a +30.80% good-outcome tail, the valuation has one method, and positioning data is missing.
...
- The $68.78 base DCF is well below the $106.79 price, but its 82.2% terminal-value share makes it sensitive. [analyses/AKAM_2026-09-14/valuation/99_valuation-synthesis.md, §§1–5]
...
- **Highest-value next item:** a same-date, matched-basis peer export with EV, LTM and NTM revenue, EBITDA, EBIT, EPS, FCF, and net debt for Cloudflare, Fortinet, and Fastly.
...
| DCF value versus market-required return | The same DCF cash path supports $106.79 at a 5.05% market-implied WACC; Security/CIS growth could make that path conservative. | At 6.22% WACC, the price requires 16.35% annual FCF growth; the valid base value is $68.78 and the matched FCF history is weaker. | Bear for owning; unresolved for shorting | The model-rate case has no cushion, but the market-rate solve is real disconfirmation. One method cannot support a high-conviction short. [analyses/AKAM_2026-09-14/valuation/99_valuation-synthesis.md, §§1–5] | 65 |
...
The valuation module controls this section. Its sole value-producing method is an intrinsic FCFF DCF—free cash flow to the firm discounted back to today and then bridged from enterprise value to equity. The EV-to-equity bridge deducts $6.0826bn of **strict net debt**, meaning $7.5628bn of debt less $1.4803bn of cash and equivalents, and divides by 153.686m diluted working shares. [analyses/AKAM_2026-09-14/valuation/01_price-and-capital-structure.md, Anchor Block]
...
| FCFF DCF | bull $109.66 / base $68.78 / `bear_cyclical` $45.65 | 100% of valid methods | One-method range; 82.2% of EV is terminal value |
| Structural reset | `bear_structural` $33.99 | Avoid-ruin cross-check | Separate 24–36 month floor, not a 12-month scenario |

The DCF uses a 6.22% WACC. The filing discloses only obligation-specific lease rates of 3.6%, 4.4%, and 5.1%, not a scope-matched group discount rate, so those rates do not replace the WACC. The reverse-DCF's 5.05% market-implied WACC is the strongest contrary read. [analyses/AKAM_2026-09-14/valuation/04_intrinsic-dcf.md, §3A; analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §2A]
...
Margin of safety—the cushion between value and price—is **−55.26% = ($68.78 − $106.79) / $68.78**. Downside to the 12-month bear is **57.25%**. These are different measures. The $33.99 structural floor implies 68.2% downside over 24–36 months and is not mixed into the 12-month math.
...
|---|---:|---|---:|---:|---|
| `bull_execution` | 10% | judgment | **+30.80%** | **$139.68** | The reverse-DCF's 16.35% annual FCF path reaches about $1.245bn in FY2030 **and** the market retains the separately solved 5.0466% WACC, with 0.80% terminal growth. One clean CIS report can improve both cash expectations and perceived risk, but either condition alone supports roughly today's price rather than this target; the 10% applies to the conjunction, not each condition separately. |
| `bull_dcf_sensitivity` | 15% | judgment | **+2.69%** | **$109.66** | FY2030 FCF reaches $972.3m, cash capex falls toward 18.5% of revenue, and the market accepts 5.22% WACC and 1.30% terminal growth. The 15% applies to this conjunction, not each condition separately. |
| `base` | 45% | judgment | **−35.59%** | **$68.78** | FY2026–FY2028 consensus revenue broadly holds, GAAP EBIT margin recovers to 14.0% by FY2030, and terminal ROIC fades to the 6.22% WACC. The probability applies to the joint operating and valuation path. |
| `bear_cyclical` | 30% | judgment | **−57.25%** | **$45.65** | The same explicit cash path is valued at 7.22% WACC and 0.30% terminal growth as capacity cost, CIS delay, and Delivery pressure weaken durability. These conditions share the same cash-durability driver. |

The module supplies the $109.66 / $68.78 / $45.65 DCF grid. The master-owned $139.68 span case uses only its frozen inputs: the reverse-DCF cash sequence of $339.7m / $790.5m / $919.8m / $1,070.2m / $1,245.1m, discounted at the reverse-DCF's exact 5.04657045% market-implied WACC with 0.80% terminal growth. This gives $3,867.4m of present-value explicit cash flow + $23,681.9m of present-value terminal cash flow = $27,549.3m enterprise value; less $6,082.6m strict net debt = $21,466.7m equity value; divided by 153.686m diluted working shares = **$139.68**. This is a master DCF inference, not a new filing forecast or an independent valuation method. [analyses/AKAM_2026-09-14/valuation/04_intrinsic-dcf.md, §§4–7; analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–2A]

**Span check:** the best case is now +30.80%, well outside an ordinary weekly move. A Security/CIS report that lifts the cash path while keeping the market-required return near 5.05% is the single news pattern that can move the stock 10% or more, and `bull_execution` contains it. The module's +2.69% grid point remains as a separate mild-upside state rather than masquerading as the full bull. The master did not use the $153.31 consensus target as valuation proof.

**Common drivers:** cash durability and required return move every case; the cases are not diversified draws. A cash-flow disappointment would also raise strict leverage, so operating and balance-sheet downside are correlated. The separate $33.99 `bear_structural` floor is a 24–36 month avoid-ruin check and is excluded from this 365-day probability set.

- Probability-weighted target: **$75.06**.
- Probability-weighted expected return: **−29.71%**.
...
- Risk/reward: **−0.52x**.
- Verdict: the expected return is not worth taking the long risk; the explicit +30.80% good-outcome tail also makes a short unsuitable.
...
| One-model valuation error | 90 | 55 | judgment | A matched independent method supports the market price or the market-required return stays near 5.05% | Same-date peer export and reverse-DCF refresh |
...
- **Checklist:** 116 of 179 tests answered, or 64.8%; 40 Green, 67 Amber, 9 Red, and 63 Not assessable. The worst binding inverted risk is contingent-liability risk at 37/100; lower is better in that family. [analyses/AKAM_2026-09-14/management-governance/99_management-governance-synthesis.md, §§1–6]
...
| RF-SHR-001 | High | 41.9% of votes cast opposed the 8.0m-share stock-plan increase | Lowers shareholder-rights confidence; no hard lock |
| RF-DISC-002 | High | Recurring SBC/restructuring exclusions and large GAAP-to-adjusted gap | Part of forensic mosaic |
| RF-AUD-007 | High | PwC U.S. 2024 censure and $2.75m penalty; **no AKAM link identified** | Audit-quality penalty only |
...
| Low required return | A 5.05% market-implied WACC supports the current price on the DCF cash path. | Reverse-DCF dual solve; 1.17 percentage points below the model WACC. [analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §2A] | Independent market/peer evidence supports a low rate and cash flow follows the path |
...
| LTM strict FCF reaches at least $733m by Q2 2027 | LTM Q2 2026 strict FCF $629.9m, same CFO-minus-total-cash-capex definition; no stub. FY2025 $699.3m and LTM Q2 2026 $629.9m were both below $733m. | The first one-year step toward the price-implied 16.35% FCF path is present. | Q2 2027 Form 10-Q and trailing cash-flow calculation | valuation; earnings |
...
- **Entry style:** no automatic entry. A fall to the $68.78 base value would trigger a fresh review, not a buy order, because the value is one-model and RF-CAP-004 remains.
...
- **What not to do:** do not short merely because base DCF is below price; the model has 82.2% terminal value and no real squeeze scenario.
...
The DCF itself is fragile: combining the price-implied 16.35% cash-growth path with the separately solved 5.0466% market-required return produces a $139.68 good-outcome value.

### Final Thesis

Avoid the long at $106.79 because the priced cash path is not proven. Also avoid the short because the distribution includes a +30.80% good-outcome tail and positioning evidence is incomplete.
...
- Probability-weighted target: **0.10 × $139.68 + 0.15 × $109.66 + 0.45 × $68.78 + 0.30 × $45.65 = $75.06**.
- Expected return: **($75.06 − $106.79) / $106.79 = −29.71%**.
- Scenario returns: `bull_execution` **+30.80%**; `bull_dcf_sensitivity` **+2.69%**; base **−35.59%**; `bear_cyclical` **−57.25%**.
- Downside risk: **−min(+30.80%, +2.69%, −35.59%, −57.25%) = 57.25%**.
- Risk/reward: **($75.06 − $106.79) / ($106.79 − $45.65) = −0.52x**.
- Margin of safety: **($68.78 − $106.79) / $68.78 = −55.26%**.

The result is highly sensitive to WACC and terminal growth. That limitation caused a 10-point conviction downgrade. The repaired span uses an explicit DCF conjunction from the frozen reverse-DCF inputs, not an invented consensus target, and its +30.80% upside helps block a short.
...
**Verdict: Materially overvalued, with low confidence.** The price is $106.79; 12-month levels are $109.66 bull, $68.78 base, and $45.65 `bear_cyclical`, with a separate $33.99 structural floor over 24–36 months. Valuation attractiveness is 10/100, margin-of-safety score 5/100, valuation confidence 50/100, downside risk 85/100 (inverted), data quality 72/100, and usefulness 62/100. The FCFF DCF is the only valid value-producing method and 82.2% of EV is terminal value. The peer and own-history reads have zero weight. Full audit trail: [analyses/AKAM_2026-09-14/valuation/99_valuation-synthesis.md].
...
| `04_intrinsic-dcf.md` | intrinsic-dcf | Base $68.78; low confidence and 82.2% terminal value. |
| `05_reverse-dcf.md` | reverse-dcf | Price requires 16.35% annual FCF growth at 6.22% WACC. |
| `06_sum-of-the-parts.md` | sum-of-the-parts | SOTP collapses because AKAM reports one segment and no category profit/capital. |
| `07_scenario-and-fair-value.md` | scenario-and-fair-value | One-method $109.66 / $68.78 / $45.65; confidence capped at 50. |
...
| Base value is $68.78 | 4 | Reproducible DCF using filing bridge and consensus inputs | One method; 82.2% terminal value | Keep, low confidence |
| Price implies 16.35% FCF growth at 6.22% WACC | 4 | Executed reverse-DCF | Model-conditional; 5.05% market-rate solve is contrary evidence | Keep with condition |
...
| A short would work | 0 | The modeled good-outcome case is +30.80%, and borrow and options data are absent | Unsupported | Remove; final action is no short |
...
| LTM strict FCF reaches at least $733m by Q2 2027 | 35% — judgment | 1 Jul–15 Aug 2027 | LTM Q2 2026 strict FCF was $629.9m; $733m is its first 16.35% annual growth step | Q2 2027 Form 10-Q cash-flow data yield LTM CFO minus property/equipment and capitalized-software cash capex ≥$733m | Same named filing and basis yield <$733m | valuation | cash_flow | 65 |
...
**Single highest-value next request:** a consistent, same-date peer export with EV, LTM and NTM revenue, EBITDA, EBIT, EPS, FCF, net debt, diluted shares, and data dates for Cloudflare, Fortinet, and Fastly. It is the most direct way to test whether the one-method $68.78 result is a false negative.
...
|---|---|
| bad base rate (n=2) | The reverse-DCF compares FCF growth with matched FCF history, not revenue, and labels four-quarter surprise history as judgment rather than a frequency. [analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§3–5; analyses/AKAM_2026-09-14/earnings/04_guidance-consensus.md, §6] |
| valuation multiple error (n=2) | Six-close own history and the heterogeneous 59.4x peer median are assigned 0% weight; the $377.81 mechanical output is excluded. [analyses/AKAM_2026-09-14/valuation/07_scenario-and-fair-value.md, §§1–2] |
...
| false negative (n=2) | The module's +2.69% bull failed the span test, so the master explicitly models the joint price-implied cash path and 5.0466% WACC at $139.68 (+30.80%), refuses a short, and retains a second valuation as the top data request. [analyses/AKAM_2026-09-14/valuation/04_intrinsic-dcf.md, §§4–7; analyses/AKAM_2026-09-14/valuation/05_reverse-dcf.md, §§2–2A; this dossier §§8–9A] |
...
Memory ran in shadow mode. Compilation for `master/synthesizer` failed because the host lacks active Xcode command-line tools. Per [frameworks/MEMORY_RUNTIME.md], this failure was recorded and the ordinary no-memory task continued. No current fact, claim, score, or rating came from memory.

The raw evidence, manifest, corpus, relationships, and deterministic CIQ facts were bound to the frozen generation named at the top. No live `data/AKAM/` source or mutable run-root `_pool_extracts` projection was read. Citations retain the stable `data/AKAM/...` labels.
