# Model Paper-Portfolio — 2026-08-11
...
| EMAAR | Watchlist | Starter long only if pre-sales hold ≥+16% YoY and the discount begins to close, or on primary evidence the Government-of-Dubai owner (or founder-MD) treats minorities as value-owners. Q2 2026 print (est. 10-Aug-2026) window has passed with no new run folding in the result. | 2026-10-08 (90d; 30d checkpoint of 2026-08-09 elapsed with no new run) |
...
*No new decision record landed since the 2026-08-10 refresh — this is a same-conclusion update. NHY's 30d checkpoint (2026-08-18) and BG/HCG's 90d checkpoint (2026-08-30) are the nearest upcoming reviews.*
