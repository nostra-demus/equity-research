...
**1 position (TSLA, short) — 1.5% gross — 6 names on watch. Unchanged from 2026-07-26.**
...
**What changed:** nothing. No new research run landed between the 2026-07-26 model portfolio and today — the standing, corrected ledger still holds the same 7 decisions from the same 7 run roots (`AMZN_2026-07-10`, `BG_2026-06-01`, `EMAAR_2026-07-10`, `HCG_2026-06-01`, `NHY_2026-07-19`, `TMCV_2026-06-07`, `TSLA_2026-07-25`). This run re-verifies eligibility and sizing against that unchanged ledger and reproduces the same book.
