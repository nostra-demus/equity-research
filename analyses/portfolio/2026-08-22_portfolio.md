# Model Paper-Portfolio — 2026-08-22
...
| NHY | Watchlist | Revisit only if price falls toward/below the NOK 70-82 fair-value band, or if the Alumetal impairment / Brazil tax risk clears without damage. | **2026-08-18 — OVERDUE (4 days).** The 30d checkpoint has elapsed with no review filed; run `/research:review-decisions` to file it. Next scheduled checkpoint after that is 2026-10-17 (90d). |
...
*No new decision records since the 2026-08-20/21 refresh — book composition and 0%-gross conclusion are unchanged. NHY's 30d review checkpoint (2026-08-18) is now 4 days overdue and still unfiled. It does not change NHY's eligibility, which was already excluded on basket/edge grounds.*
