...
**1 position (TSLA, short) — 1.5% gross — 6 names on watch.**
...
**What changed:** TSLA (`analyses/TSLA_2026-07-25`, Short Candidate, basket = Short) is the first name in this ledger's history to clear Step-2 eligibility. All 6 prior standing records (AMZN, BG, EMAAR, HCG, NHY, TMCV) are unchanged from the 2026-07-25 run.
