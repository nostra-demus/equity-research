...
**New this run:** NHY (Norsk Hydro ASA) — decision date 2026-07-19, Watchlist, expected return −8.4%, edge score 30 (below the 50 exploitability gate), confidence 35, data sufficiency 78. Carries five High-severity red flags (unaligned Norwegian-state ownership stake RF-OWN-004, a written-off battery-materials growth bet RF-CAP-001, dividend exceeding free cash flow two years running RF-CAP-003, a "non-recurring" restructuring charge that has recurred and grown for three straight years RF-DISC-002, and a 26%-against vote on FY2024 pay at the 2025 AGM RF-SHR-001). No position at current price; the 22-Jul-2026 FQ2 print is the near-term test of the margin/cash-conversion reconciliation.
