# Model Paper-Portfolio — 2026-08-09
...
|---|---|---|---|
| AMZN | Watchlist | Re-entry at $190-200 (>12% margin of safety on base fair value $210). Jul-31-2026 Q2 print was the first real test of the AWS D&A billing-lag hypothesis — not yet folded into a new run. | 2026-08-09 (due today) |
...
| EMAAR | Watchlist | Starter long only if pre-sales hold ≥+16% YoY and the discount begins to close, or on primary evidence the Government-of-Dubai owner (or founder-MD) treats minorities as value-owners. Q2 2026 print (est. 10-Aug-2026) is due tomorrow. | 2026-08-09 (due today) |
...
*Two 30-day checkpoints (AMZN, EMAAR) fall due today, 2026-08-09 — no action required unless a fresh run changes the underlying decision record.*
