...
assert.match(doctrineText, /Without explicit authority for a specific merge, a code task is "done" only at an open, green, reviewed PR/)
assert.match(doctrineText, /A human-authorized\s+merge delegates only its exact automatic release/)
