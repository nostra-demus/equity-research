...
export interface RawArticle {
  ...
  via?: 'gdelt' | 'rss' | 'nse' | 'hkex' | 'asx' | 'hkex' | 'asx' // which fetcher found it (provenance for the live feed)
...
export interface NewsItem {
  ...
  via?: 'gdelt' | 'rss' | 'nse' | 'hkex' | 'asx' // which fetcher found it
