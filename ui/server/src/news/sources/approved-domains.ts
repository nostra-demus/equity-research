...
const DOMAINS: Record<string, SourceMeta> = {
  ...
  'bankofengland.co.uk': { source_name: 'Bank of England', region: 'GLOBAL', input_nature: 'macro_data_release', gdelt: false },
  'bbc.com': { source_name: 'BBC News', region: 'GLOBAL', input_nature: 'news_headline', gdelt: false },
  'bis.org': { source_name: 'Bank for International Settlements', region: 'GLOBAL', input_nature: 'macro_data_release', gdelt: false },
  'boj.or.jp': { source_name: 'Bank of Japan', region: 'GLOBAL', input_nature: 'macro_data_release', gdelt: false },
  ...
  'fca.org.uk': { source_name: 'UK Financial Conduct Authority (FCA)', region: 'GLOBAL', input_nature: 'regulatory_filing', gdelt: false },
  ...
  'nikkei.com': { source_name: 'Nikkei Asia', region: 'GLOBAL', input_nature: 'news_headline', gdelt: false },
  ...
  'scmp.com': { source_name: 'South China Morning Post', region: 'GLOBAL', input_nature: 'news_headline', gdelt: false },
  ...
  'theguardian.com': { source_name: 'The Guardian', region: 'GLOBAL', input_nature: 'news_headline', gdelt: false },
