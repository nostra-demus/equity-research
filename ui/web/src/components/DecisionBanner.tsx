...
export function DecisionBanner() {
  ...
  return (
    <motion.div className="decision" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, ease: [0.16, 1, 0.3, 1] }} onClick={openThesis} style={{ cursor: 'pointer' }} title="Open the final thesis">
      ...
      <div className="decision__divider" />
      <span className="decision__stat" style={{ color: 'var(--accent)' }}>read thesis →</span>
    </motion.div>
  )
}
